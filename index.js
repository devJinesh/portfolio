document.addEventListener("DOMContentLoaded", () => {
    ...
    // Render Resume
    const resumeUrl = baseUrl + "assets/Jinesh_Chhajer_Resume.pdf";
    ...
    downloadLink.setAttribute("download", "Jinesh_Chhajer_Resume");
    ...
    downloadResume.addEventListener("click", () => {
        ...
        resumeLink.setAttribute("download", "Jinesh_Chhajer_Resume");
        resumeLink.click();
    })
